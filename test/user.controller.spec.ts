...
import { CreateUserCommand } from 'user/command/create-user.command';
import { CreateUserDto } from 'user/dto/create-user.dto';
import { UserRank } from 'common/types/userRank';
import { UpdateUserDto } from 'user/dto/update-user.dto';
import { UpdateUserCommand } from 'user/command/update-user.command';
import { UpdateUserRankCommand } from 'user/command/update-user-rank.command';
import { DeleteUserCommand } from 'user/command/delete-user.command';
import { ApproveUserCommand } from 'user/command/approve-user.command';
import { GetUserQuery } from 'user/query/get-user.query';
...
describe('UserController', () => {
  ...
  describe('createUser', () => {
    it('should create a new user', async () => {
      const mockUUID = 'b0befe57-e359-4a5a-9d58-019a95cf6404';
      ...
      expect(createdUser.id).toEqual(mockUUID);
...
//       .mockResolvedValueOnce({ ...mockUser, isActivate: true });
